...
import User, {getAllUsers, getUser, getUserId} from "../models/User.js"; // import User model, getUser, getUserId function from User.js
import {comparePassword, hashPassword} from "../utils/hashPassword.js"; // import hashPassword, compareFunction arrow function from hashPassword.js
...
export const me = async (req, res, next) => {
    try {
        ...
        res.json({status: "success", user: user}); // return status OK and give data
    } catch (err) {
        next(err);
    }
};
